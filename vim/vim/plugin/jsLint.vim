...
" Version:      0.1
" Description:  Run js -l (syntax check) on the current file each time it's saved
" Last Modified: Jul 20, 2012

if !exists("js_command")
  let js_command = 'jslint'
endif

if !exists("js_command_options")
  let js_command_options = ' -nologo -nofilelisting -nosummary -process '
endif
...
autocmd BufWritePost,FileWritePost *.js call JSLint()
